...
var CanUseRemotionHooksProvider = ({ children }) => {
  return (0, import_jsx_runtime.jsx)(CanUseRemotionHooks.Provider, {
    value: true,
    children
  });
};
...
var Folder = ({ name, children }) => {
  ...
  return (0, import_jsx_runtime2.jsx)(FolderContext.Provider, {
    value,
    children
  });
};
...
var IsPlayerContextProvider = ({
  ...
  return (0, import_jsx_runtime3.jsx)(IsPlayerContext.Provider, {
    value: true,
    children
  });
};
...
var Loading = () => {
  return (0, import_jsx_runtime5.jsxs)(AbsoluteFill, {
    style: container,
...
var EditorPropsProvider = ({ children }) => {
  ...
  return (0, import_jsx_runtime6.jsx)(EditorPropsContext.Provider, {
    value: ctx,
    children
  });
};
...
var InnerComposition = ({
  ...
  if (environment.isStudio && video && video.component === lazy && video.id === id) {
    ...
    return (0, import_react_dom.createPortal)((0, import_jsx_runtime7.jsx)(CanUseRemotionHooksProvider, {
      children: (0, import_jsx_runtime7.jsx)(CompositionErrorBoundary, {
        onError,
        onClear,
        children: (0, import_jsx_runtime7.jsx)(import_react2.Suspense, {
          fallback: (0, import_jsx_runtime7.jsx)(Loading, {}),
          children: (0, import_jsx_runtime7.jsx)(Comp, {
  ...
  if (environment.isRendering && video && video.component === lazy && video.id === id) {
    ...
    return (0, import_react_dom.createPortal)((0, import_jsx_runtime7.jsx)(CanUseRemotionHooksProvider, {
      children: (0, import_jsx_runtime7.jsx)(import_react2.Suspense, {
        fallback: (0, import_jsx_runtime7.jsx)(Fallback, {}),
        children: (0, import_jsx_runtime7.jsx)(Comp, {
          ...resolved.result.props ?? {}
        })
      })
...
var Composition = (props) => {
  ...
  return (0, import_jsx_runtime7.jsx)(InnerComposition, {
    ...props
  });
};
...
var TimelineContextProvider = ({ children, frameState }) => {
  ...
  const imperativePlaying = (0, import_react23.useRef)(false);
  const [playbackRate, setPlaybackRate] = (0, import_react23.useState)(1);
  const audioAndVideoTags = (0, import_react23.useRef)([]);
  const [remotionRootId] = (0, import_react23.useState)(() => String(random(null)));
  const [_frame, setFrame] = (0, import_react23.useState)(() => getInitialFrameState());
  ...
  const timelineContextValue = (0, import_react23.useMemo)(() => {
    return {
      frame,
      playing,
      imperativePlaying,
  ...
  const playbackRateContextValue = (0, import_react23.useMemo)(() => {
    return {
      playbackRate,
      setPlaybackRate
    };
  }, [playbackRate]);
  const setTimelineContextValue = (0, import_react23.useMemo)(() => {
    return {
      setFrame,
      setPlaying
    };
  }, []);
  return (0, import_jsx_runtime8.jsx)(AbsoluteTimeContext.Provider, {
    value: timelineContextValue,
    children: (0, import_jsx_runtime8.jsx)(PlaybackRateContext.Provider, {
      value: playbackRateContextValue,
      children: (0, import_jsx_runtime8.jsx)(TimelineContext.Provider, {
        value: timelineContextValue,
        children: (0, import_jsx_runtime8.jsx)(SetTimelineContext.Provider, {
...
var useEffectChainState = () => {
  const chainStateRef = (0, import_react24.useRef)(null);
  const sizeRef = (0, import_react24.useRef)(null);
...
var Solid = ({
  ...
  const [outputCanvas, setOutputCanvas] = (0, import_react19.useState)(null);
  const sourceCanvas = (0, import_react19.useMemo)(() => {
    if (typeof document === "undefined") {
      return null;
    }
    const canvas = document.createElement("canvas");
  ...
  return (0, import_jsx_runtime9.jsx)("canvas", {
    ref: setOutputCanvas,
    width,
    height,
    className,
...
var useMemoizedEffects = (effects) => {
  const previousRef = (0, import_react26.useRef)(null);
...
var useUnsafeVideoConfig = () => {
  const context = (0, import_react29.useContext)(SequenceContext);
...
var useVideoConfig = () => {
  ...
  const context = (0, import_react28.useContext)(CanUseRemotionHooks);
  const isPlayer = useIsPlayer();
  if (!videoConfig) {
...
var Freeze = ({
  ...
  const isActive = (0, import_react27.useMemo)(() => {
  ...
  const sequenceContext = (0, import_react27.useContext)(SequenceContext);
  const relativeFrom = sequenceContext?.relativeFrom ?? 0;
  const timelineValue = (0, import_react27.useMemo)(() => {
    if (!isActive) {
  ...
  const newSequenceContext = (0, import_react27.useMemo)(() => {
    if (!sequenceContext) {
      return null;
    }
    if (!isActive) {
  ...
  return (0, import_jsx_runtime10.jsx)(TimelineContext.Provider, {
    value: timelineValue,
    children: (0, import_jsx_runtime10.jsx)(SequenceContext.Provider, {
      value: newSequenceContext,
      children
    })
  });
};
var PremountContext = (0, import_react30.createContext)({
...
var SequenceManager = import_react31.default.createContext({
  registerSequence: () => {
...
var SequenceVisibilityToggleContext = import_react31.default.createContext({
  hidden: {},
  setHidden: () => {
    throw new Error("SequenceVisibilityToggle not initialized");
  }
});
var VisualModeOverridesContext = import_react31.default.createContext({
  dragOverrides: {},
  setDragOverrides: () => {
...
var SequenceManagerProvider = ({ children, visualModeEnabled }) => {
  const [sequences, setSequences] = (0, import_react31.useState)([]);
  const [hidden, setHidden] = (0, import_react31.useState)({});
  const [dragOverrides, setControlOverrides] = (0, import_react31.useState)({});
  const controlOverridesRef = (0, import_react31.useRef)(dragOverrides);
  controlOverridesRef.current = dragOverrides;
  const [codeValues, setCodeValuesMapState] = (0, import_react31.useState)({});
  const setDragOverrides = (0, import_react31.useCallback)((sequenceId, key, value) => {
  ...
  const clearDragOverrides = (0, import_react31.useCallback)((sequenceId) => {
    setControlOverrides((prev) => {
      if (!prev[sequenceId]) {
        return prev;
      }
  ...
  const setCodeValues = (0, import_react31.useCallback)((sequenceId, values) => {
  ...
  const registerSequence = (0, import_react31.useCallback)((seq) => {
    setSequences((seqs) => {
      return [...seqs, seq];
    });
  }, []);
  const unregisterSequence = (0, import_react31.useCallback)((seq) => {
    setSequences((seqs) => seqs.filter((s) => s.id !== seq));
  }, []);
  const sequenceContext = (0, import_react31.useMemo)(() => {
    return {
      registerSequence,
      sequences,
      unregisterSequence
  ...
  const hiddenContext = (0, import_react31.useMemo)(() => {
    return {
      hidden,
      setHidden
    };
  }, [hidden]);
  const overrideContext = (0, import_react31.useMemo)(() => {
    return {
      visualModeEnabled,
      dragOverrides,
      setDragOverrides,
  ...
  return (0, import_jsx_runtime11.jsx)(SequenceManager.Provider, {
    value: sequenceContext,
    children: (0, import_jsx_runtime11.jsx)(SequenceVisibilityToggleContext.Provider, {
      value: hiddenContext,
      children: (0, import_jsx_runtime11.jsx)(VisualModeOverridesContext.Provider, {
...
var wrapInSchema = (Component, schema) => {
  ...
  const Wrapped = (0, import_react32.forwardRef)((props, ref) => {
    const env = useRemotionEnvironment();
    const { visualModeEnabled, dragOverrides, codeValues } = (0, import_react32.useContext)(VisualModeOverridesContext);
    ...
    const [overrideId] = (0, import_react32.useState)(() => String(Math.random()));
    const runtimeValues = flatKeys.map((k) => getNestedValue(props, k));
    const currentRuntimeValueDotNotation = (0, import_react32.useMemo)(() => readValuesFromProps(props, flatKeys), runtimeValues);
    ...
    const valuesDotNotation = (0, import_react32.useMemo)(() => {
...
var RegularSequenceRefForwardingFunction = ({
  ...
  const [id] = (0, import_react25.useState)(() => String(Math.random()));
  const parentSequence = (0, import_react25.useContext)(SequenceContext);
  ...
  const { registerSequence, unregisterSequence } = (0, import_react25.useContext)(SequenceManager);
  const { hidden } = (0, import_react25.useContext)(SequenceVisibilityToggleContext);
  const premounting = (0, import_react25.useMemo)(() => {
    return parentSequence?.premounting || Boolean(other._remotionInternalIsPremounting);
  }, [other._remotionInternalIsPremounting, parentSequence?.premounting]);
  const postmounting = (0, import_react25.useMemo)(() => {
  ...
  const timelineClipName = (0, import_react25.useMemo)(() => {
    return name ?? "";
  }, [name]);
  const env = useRemotionEnvironment();
  ...
  const defaultStyle = (0, import_react25.useMemo)(() => {
    return {
  ...
  return (0, import_jsx_runtime12.jsx)(SequenceContext.Provider, {
    value: contextValue,
    children: content === null ? null : other.layout === "none" ? content : (0, import_jsx_runtime12.jsx)(AbsoluteFill, {
      ref,
      style: defaultStyle,
      className: other.className,
      children: content
...
var RegularSequence = (0, import_react25.forwardRef)(RegularSequenceRefForwardingFunction);
var PremountedPostmountedSequenceRefForwardingFunction = (props, ref) => {
  const parentPremountContext = (0, import_react25.useContext)(PremountContext);
  ...
  return (0, import_jsx_runtime12.jsx)(Freeze, {
    frame: freezeFrame,
    active: isFreezingActive,
    children: (0, import_jsx_runtime12.jsx)(SequenceInner, {
      ref,
      from,
      durationInFrames,
      style,
...
var PremountedPostmountedSequence = (0, import_react25.forwardRef)(PremountedPostmountedSequenceRefForwardingFunction);
var SequenceRefForwardingFunction = (props, ref) => {
  ...
  if (props.layout !== "none" && !env.isRendering) {
    ...
    if (effectivePremountFor || props.postmountFor) {
      return (0, import_jsx_runtime12.jsx)(PremountedPostmountedSequence, {
        ref,
        ...props,
  ...
  return (0, import_jsx_runtime12.jsx)(RegularSequence, {
    ...props,
    ref
  });
};
var SequenceInner = (0, import_react25.forwardRef)(SequenceRefForwardingFunction);
...
var CanvasRefForwardingFunction = ({ width, height, fit, className, style }, ref) => {
  ...
  const draw = (0, import_react34.useCallback)((imageData) => {
  ...
  return (0, import_jsx_runtime13.jsx)("canvas", {
    ref: canvasRef,
    className,
    style
  });
};
var Canvas = import_react34.default.forwardRef(CanvasRefForwardingFunction);
var CACHE_SIZE = 5;
var getActualTime = ({
  loopBehavior,
  durationFound,
...
var AnimatedImage = (0, import_react33.forwardRef)(({
  src,
  width,
  height,
  onError,
  ...
  const mountState = (0, import_react33.useRef)({ isMounted: true });
  ...
  const [imageDecoder, setImageDecoder] = (0, import_react33.useState)(null);
  const { delayRender: delayRender2, continueRender: continueRender2 } = useDelayRender();
  const [decodeHandle] = (0, import_react33.useState)(() => delayRender2(`Rendering <AnimatedImage/> with src="${resolvedSrc}"`));
  const frame = useCurrentFrame();
  const { fps } = useVideoConfig();
  const currentTime = frame / playbackRate / fps;
  const currentTimeRef = (0, import_react33.useRef)(currentTime);
  currentTimeRef.current = currentTime;
  const ref = (0, import_react33.useRef)(null);
  (0, import_react33.useImperativeHandle)(canvasRef, () => {
  ...
  const [initialLoopBehavior] = (0, import_react33.useState)(() => loopBehavior);
  (0, import_react33.useEffect)(() => {
  ...
  return (0, import_jsx_runtime14.jsx)(Canvas, {
    ref,
    width,
    height,
    fit,
...
var HtmlInCanvasAncestorContext = (0, import_react35.createContext)(false);
var HtmlInCanvasInner = (0, import_react35.forwardRef)(({
  width,
  height,
  ...
  const isInsideAncestorHtmlInCanvas = (0, import_react35.useContext)(HtmlInCanvasAncestorContext);
  ...
  const frame = useCurrentFrame();
  const canvas2dRef = (0, import_react35.useRef)(null);
  const divRef = (0, import_react35.useRef)(null);
  const setLayoutCanvasRef = (0, import_react35.useCallback)((node) => {
  ...
  const [offscreenCanvas] = (0, import_react35.useState)(() => new OffscreenCanvas(1, 1));
  const chainState = useEffectChainState();
  const effectsRef = (0, import_react35.useRef)(effects);
  effectsRef.current = effects;
  const frameRef = (0, import_react35.useRef)(frame);
  frameRef.current = frame;
  const onPaintRef = (0, import_react35.useRef)(onPaint);
  onPaintRef.current = onPaint;
  const onInitRef = (0, import_react35.useRef)(onInit);
  onInitRef.current = onInit;
  const initializedRef = (0, import_react35.useRef)(false);
  const onInitCleanupRef = (0, import_react35.useRef)(null);
  const unmountedRef = (0, import_react35.useRef)(false);
  const onPaintCb = (0, import_react35.useCallback)(async () => {
  ...
  const onPaintChangedRef = (0, import_react35.useRef)(false);
  (0, import_react35.useLayoutEffect)(() => {
  ...
  const innerStyle = (0, import_react35.useMemo)(() => {
    return {
      width,
      height
    };
  ...
  return (0, import_jsx_runtime15.jsx)(Sequence, {
    ...
    layout: "none",
    ...sequenceProps,
    children: (0, import_jsx_runtime15.jsx)(HtmlInCanvasAncestorContext.Provider, {
      value: true,
      children: (0, import_jsx_runtime15.jsx)("canvas", {
...
var RenderAssetManager = (0, import_react37.createContext)({
  registerRenderAsset: () => {
    return;
  },
...
var RenderAssetManagerProvider = ({ children, collectAssets }) => {
  const [renderAssets, setRenderAssets] = (0, import_react37.useState)([]);
  const renderAssetsRef = (0, import_react37.useRef)([]);
  const registerRenderAsset = (0, import_react37.useCallback)((renderAsset) => {
    validateRenderAsset(renderAsset);
    renderAssetsRef.current = [...renderAssetsRef.current, renderAsset];
    setRenderAssets(renderAssetsRef.current);
  }, []);
  if (collectAssets) {
    (0, import_react37.useImperativeHandle)(collectAssets, () => {
      return {
        collectAssets: () => {
  ...
  const unregisterRenderAsset = (0, import_react37.useCallback)((id) => {
  ...
  return (0, import_jsx_runtime16.jsx)(RenderAssetManager.Provider, {
    value: contextValue,
    children
  });
};
...
var Artifact = ({ filename, content, downloadBehavior }) => {
  const { registerRenderAsset, unregisterRenderAsset } = (0, import_react36.useContext)(RenderAssetManager);
  const env = useRemotionEnvironment();
  const frame = useCurrentFrame();
  const [id] = (0, import_react36.useState)(() => {
...
var LoopContext = (0, import_react39.createContext)(null);
var useLoop = () => {
  return import_react39.default.useContext(LoopContext);
};
var Loop = ({
  durationInFrames,
  times = Infinity,
  ...
  const loopDisplay = (0, import_react39.useMemo)(() => {
    return {
  ...
  const loopContext = (0, import_react39.useMemo)(() => {
    return {
      iteration: Math.floor(currentFrame / durationInFrames),
      durationInFrames
    };
  }, [currentFrame, durationInFrames]);
  return (0, import_jsx_runtime17.jsx)(LoopContext.Provider, {
    value: loopContext,
    children: (0, import_jsx_runtime17.jsx)(Sequence, {
      durationInFrames,
      from,
      name: name ?? "<Loop>",
      _remotionInternalLoopDisplay: loopDisplay,
...
var PreloadContext = (0, import_react41.createContext)({});
var preloads = {};
var updaters = [];
...
var PrefetchProvider = ({ children }) => {
  const [_preloads, _setPreloads] = (0, import_react41.useState)(() => preloads);
  ...
  return (0, import_jsx_runtime18.jsx)(PreloadContext.Provider, {
    value: _preloads,
    children
  });
};
...
var usePreload = (src) => {
  const preloads2 = (0, import_react40.useContext)(PreloadContext);
...
var DurationsContext = (0, import_react42.createContext)({
  durations: {},
  setDurations: () => {
...
var DurationsContextProvider = ({ children }) => {
  const [durations, setDurations] = (0, import_react42.useReducer)(durationReducer, {});
  ...
  return (0, import_jsx_runtime19.jsx)(DurationsContext.Provider, {
    value,
    children
  });
};
...
var SharedAudioContext = (0, import_react45.createContext)(null);
var SharedAudioTagsContext = (0, import_react45.createContext)(null);
var SharedAudioContextProvider = ({ children, audioLatencyHint, audioEnabled }) => {
  ...
  const audioContextIsPlayingEventually = (0, import_react45.useRef)(false);
  const isResuming = (0, import_react45.useRef)(null);
  const audioSyncAnchor = (0, import_react45.useMemo)(() => ({ value: 0 }), []);
  const audioSyncAnchorListeners = (0, import_react45.useRef)([]);
  const audioSyncAnchorEmitter = (0, import_react45.useMemo)(() => {
    return {
      dispatch: (event) => {
  ...
  const prevEndTimes = (0, import_react45.useRef)({ scheduledEndTime: null, mediaEndTime: null });
  const nodesToResume = (0, import_react45.useRef)(/* @__PURE__ */ new Map());
  const unscheduleAudioNode = (0, import_react45.useCallback)((node) => {
    nodesToResume.current.delete(node);
  }, []);
  const scheduleAudioNode = (0, import_react45.useMemo)(() => {
    return ({
      node,
      mediaTimestamp,
      currentTime,
  ...
  const resume = (0, import_react45.useCallback)(() => {
    if (!ctxAndGain) {
  ...
  const getIsResumingAudioContext = (0, import_react45.useCallback)(() => {
    return isResuming.current;
  }, []);
  const suspend = (0, import_react45.useCallback)(() => {
    if (!ctxAndGain) {
      return;
    }
    if (!audioContextIsPlayingEventually.current) {
  ...
  const audioContextValue = (0, import_react45.useMemo)(() => {
    return {
  ...
  return (0, import_jsx_runtime20.jsx)(SharedAudioContext.Provider, {
    value: audioContextValue,
    children
  });
};
var SharedAudioTagsContextProvider = ({ children, numberOfAudioTags }) => {
  const audios = (0, import_react45.useRef)([]);
  const [initialNumberOfAudioTags] = (0, import_react45.useState)(numberOfAudioTags);
  ...
  const env = useRemotionEnvironment();
  const audioCtx = (0, import_react45.useContext)(SharedAudioContext);
  const audioContext = audioCtx?.audioContext ?? null;
  const resume = audioCtx?.resume;
  const refs = (0, import_react45.useMemo)(() => {
    return new Array(numberOfAudioTags).fill(true).map(() => {
      const ref = (0, import_react45.createRef)();
      return {
        id: Math.random(),
        ref,
  ...
  const takenAudios = (0, import_react45.useRef)(new Array(numberOfAudioTags).fill(false));
  const rerenderAudios = (0, import_react45.useCallback)(() => {
    refs.forEach(({ ref, id }) => {
  ...
  const registerAudio = (0, import_react45.useCallback)((options) => {
  ...
  const unregisterAudio = (0, import_react45.useCallback)((id) => {
    const cloned = [...takenAudios.current];
  ...
  const updateAudio = (0, import_react45.useCallback)(({
    aud,
    audioId,
    id,
    premounting,
  ...
  const playAllAudios = (0, import_react45.useCallback)(() => {
    refs.forEach((ref) => {
  ...
  const audioTagsValue = (0, import_react45.useMemo)(() => {
    return {
      registerAudio,
      unregisterAudio,
      updateAudio,
  ...
  return (0, import_jsx_runtime20.jsxs)(SharedAudioTagsContext.Provider, {
    value: audioTagsValue,
    children: [
      refs.map(({ id, ref }) => {
        return (0, import_jsx_runtime20.jsx)("audio", {
          ref,
          preload: "metadata",
          src: EMPTY_AUDIO
        }, id);
...
var useSharedAudio = ({
  ...
  const audioCtx = (0, import_react45.useContext)(SharedAudioContext);
  const tagsCtx = (0, import_react45.useContext)(SharedAudioTagsContext);
  const [elem] = (0, import_react45.useState)(() => {
    if (tagsCtx && tagsCtx.numberOfAudioTags > 0) {
      return tagsCtx.registerAudio({ aud, audioId, premounting, postmounting });
    }
    const el = import_react45.default.createRef();
...
var useAppendVideoFragment = ({
  ...
  const actualFromRef = (0, import_react47.useRef)(initialActualFrom);
  const actualDuration = (0, import_react47.useRef)(initialDuration);
  const actualSrc = (0, import_react47.useRef)(initialActualSrc);
...
var useVolume = ({
  ...
  const audioStuffRef = (0, import_react44.useRef)(null);
  const currentVolumeRef = (0, import_react44.useRef)(volume);
  currentVolumeRef.current = volume;
  const sharedAudioContext = (0, import_react44.useContext)(SharedAudioContext);
...
var useMediaStartsAt = () => {
  const parentSequence = (0, import_react49.useContext)(SequenceContext);
...
var useBasicMediaInTimeline = ({
  ...
  const parentSequence = (0, import_react48.useContext)(SequenceContext);
  const [initialVolume] = (0, import_react48.useState)(() => volume);
  ...
  const volumes = (0, import_react48.useMemo)(() => {
    if (typeof volume === "number") {
      return volume;
    }
  ...
  const memoizedResult = (0, import_react48.useMemo)(() => {
    return {
      volumes,
      duration,
      doesVolumeChange,
...
var useImageInTimeline = ({
  ...
  const parentSequence = (0, import_react48.useContext)(SequenceContext);
  const { registerSequence, unregisterSequence } = (0, import_react48.useContext)(SequenceManager);
...
var useBufferManager = (logLevel, mountTime) => {
  const [blocks, setBlocks] = (0, import_react53.useState)([]);
  const [onBufferingCallbacks, setOnBufferingCallbacks] = (0, import_react53.useState)([]);
  const [onResumeCallbacks, setOnResumeCallbacks] = (0, import_react53.useState)([]);
  const env = useRemotionEnvironment();
  const rendering = env.isRendering;
  const buffering = (0, import_react53.useRef)(false);
  const addBlock = (0, import_react53.useCallback)((block) => {
    if (rendering) {
      return {
        unblock: () => {
          return;
  ...
  const listenForBuffering = (0, import_react53.useCallback)((callback) => {
  ...
  const listenForResume = (0, import_react53.useCallback)((callback) => {
...
var BufferingContextReact = import_react53.default.createContext(null);
var BufferingProvider = ({ children }) => {
  const { logLevel, mountTime } = (0, import_react53.useContext)(LogLevelContext);
  const bufferManager = useBufferManager(logLevel ?? "info", mountTime);
  return (0, import_jsx_runtime21.jsx)(BufferingContextReact.Provider, {
    value: bufferManager,
    children
  });
};
var useIsPlayerBuffering = (bufferManager) => {
  const [isBuffering, setIsBuffering] = (0, import_react53.useState)(bufferManager.buffering.current);
  (0, import_react53.useEffect)(() => {
    const onBuffer = () => {
      setIsBuffering(true);
    };
...
var useBufferState = () => {
  const buffer = (0, import_react52.useContext)(BufferingContextReact);
...
var useBufferUntilFirstFrame = ({
  ...
  const bufferingRef = (0, import_react51.useRef)(false);
  const { delayPlayback } = useBufferState();
  const bufferUntilFirstFrame = (0, import_react51.useCallback)((requestedTime) => {
    if (mediaType !== "video") {
      return;
    }
...
var useCurrentTimeOfMediaTagWithUpdateTimeStamp = (mediaRef) => {
  const lastUpdate = import_react54.default.useRef({
...
var useMediaBuffering = ({
  ...
  const [isBuffering, setIsBuffering] = (0, import_react55.useState)(false);
...
var useRequestVideoCallbackTime = ({
  ...
  const currentTime = (0, import_react56.useRef)(null);
...
var useMediaPlayback = ({
  ...
  const buffering = (0, import_react50.useContext)(BufferingContextReact);
  const { fps } = useVideoConfig();
  const mediaStartsAt = useMediaStartsAt();
  const lastSeekDueToShift = (0, import_react50.useRef)(null);
  const lastSeek = (0, import_react50.useRef)(null);
  const logLevel = useLogLevel();
  const mountTime = useMountTime();
  if (!buffering) {
    throw new Error("useMediaPlayback must be used inside a <BufferingContext>");
  }
  const isVariableFpsVideoMap = (0, import_react50.useRef)({});
  const onVariableFpsVideoDetected = (0, import_react50.useCallback)(() => {
    if (!src) {
      return;
    }
...
var MediaVolumeContext = (0, import_react58.createContext)({
  mediaMuted: false,
  mediaVolume: 1
});
var SetMediaVolumeContext = (0, import_react58.createContext)({
  setMediaMuted: () => {
    throw new Error("default");
  },
  setMediaVolume: () => {
...
var useMediaVolumeState = () => {
  const { mediaVolume } = (0, import_react58.useContext)(MediaVolumeContext);
  const { setMediaVolume } = (0, import_react58.useContext)(SetMediaVolumeContext);
  return (0, import_react58.useMemo)(() => {
    return [mediaVolume, setMediaVolume];
  }, [mediaVolume, setMediaVolume]);
};
var useMediaMutedState = () => {
  const { mediaMuted } = (0, import_react58.useContext)(MediaVolumeContext);
  const { setMediaMuted } = (0, import_react58.useContext)(SetMediaVolumeContext);
  return (0, import_react58.useMemo)(() => {
...
var AudioForDevelopmentForwardRefFunction = (props, ref) => {
  const [initialShouldPreMountAudioElements] = (0, import_react43.useState)(props.shouldPreMountAudioTags);
  ...
  const { hidden } = (0, import_react43.useContext)(SequenceVisibilityToggleContext);
  if (!src) {
    throw new TypeError("No 'src' was passed to <Html5Audio>.");
  }
  const preloadedSrc = usePreload(src);
  const sequenceContext = (0, import_react43.useContext)(SequenceContext);
  const [timelineId] = (0, import_react43.useState)(() => String(Math.random()));
  ...
  const propsToPass = (0, import_react43.useMemo)(() => {
    return {
  ...
  const id = (0, import_react43.useMemo)(() => `audio-${random(src ?? "")}-${sequenceContext?.relativeFrom}-${sequenceContext?.cumulatedFrom}-${sequenceContext?.durationInFrames}-muted:${props.muted}-loop:${props.loop}`, [
    src,
  ...
  const effectToUse = import_react43.default.useInsertionEffect ?? import_react43.default.useLayoutEffect;
  effectToUse(() => {
    return () => {
      requestAnimationFrame(() => {
        cleanupOnMediaTagUnmount();
  ...
  const currentOnDurationCallback = (0, import_react43.useRef)(onDuration);
  ...
  return (0, import_jsx_runtime22.jsx)("audio", {
    ref: audioRef,
    preload: "metadata",
    crossOrigin: crossOriginValue,
    ...propsToPass
...
var AudioForPreview = (0, import_react43.forwardRef)(AudioForDevelopmentForwardRefFunction);
var AudioForRenderingRefForwardingFunction = (props, ref) => {
  const audioRef = (0, import_react59.useRef)(null);
  const {
    volume: volumeProp,
    playbackRate,
    allowAmplificationDuringRender,
  ...
  const volumePropFrame = useFrameForVolumeProp(loopVolumeCurveBehavior ?? "repeat");
  const frame = useCurrentFrame();
  const sequenceContext = (0, import_react59.useContext)(SequenceContext);
  const { registerRenderAsset, unregisterRenderAsset } = (0, import_react59.useContext)(RenderAssetManager);
  const { delayRender: delayRender2, continueRender: continueRender2 } = useDelayRender();
  const id = (0, import_react59.useMemo)(() => `audio-${random(props.src ?? "")}-${sequenceContext?.relativeFrom}-${sequenceContext?.cumulatedFrom}-${sequenceContext?.durationInFrames}`, [
    props.src,
    sequenceContext?.relativeFrom,
    sequenceContext?.cumulatedFrom,
    sequenceContext?.durationInFrames
  ...
  return (0, import_jsx_runtime23.jsx)("audio", {
    ref: audioRef,
    ...nativeProps,
    onError: onNativeError
  });
};
var AudioForRendering = (0, import_react59.forwardRef)(AudioForRenderingRefForwardingFunction);
var AudioRefForwardingFunction = (props, ref) => {
  const audioTagsContext = (0, import_react38.useContext)(SharedAudioTagsContext);
  const {
    startFrom,
    endAt,
    trimBefore,
  ...
  const { durations, setDurations } = (0, import_react38.useContext)(DurationsContext);
  if (typeof props.src !== "string") {
    throw new TypeError(`The \`<Html5Audio>\` tag requires a string for \`src\`, but got ${JSON.stringify(props.src)} instead.`);
  }
  const preloadedSrc = usePreload(props.src);
  const onError = (0, import_react38.useCallback)((e) => {
  ...
  const onDuration = (0, import_react38.useCallback)((src, durationInSeconds) => {
  ...
  if (loop && durationFetched !== void 0) {
    if (!Number.isFinite(durationFetched)) {
      return (0, import_jsx_runtime24.jsx)(Html5Audio, {
        ...propsOtherThanLoop,
        ref,
    ...
    return (0, import_jsx_runtime24.jsx)(Loop, {
      layout: "none",
      ...
      children: (0, import_jsx_runtime24.jsx)(Html5Audio, {
        ...propsOtherThanLoop,
        ref,
        _remotionInternalNativeLoopPassed: true
      })
  ...
  if (typeof trimBeforeValue !== "undefined" || typeof trimAfterValue !== "undefined") {
    return (0, import_jsx_runtime24.jsx)(Sequence, {
      layout: "none",
  ...
  if (environment.isRendering) {
    return (0, import_jsx_runtime24.jsx)(AudioForRendering, {
      onDuration,
      ...props,
      ref,
  ...
  return (0, import_jsx_runtime24.jsx)(AudioForPreview, {
...
var Html5Audio = (0, import_react38.forwardRef)(AudioRefForwardingFunction);
...
var IFrameRefForwarding = ({
  ...
  const { delayRender: delayRender2, continueRender: continueRender2 } = useDelayRender();
  const [handle] = (0, import_react60.useState)(() => delayRender2(`Loading <IFrame> with source ${props2.src}`, {
    retries: delayRenderRetries ?? void 0,
    timeoutInMilliseconds: delayRenderTimeoutInMilliseconds ?? void 0
  }));
  const didLoad = (0, import_react60.useCallback)((e) => {
    continueRender2(handle);
    onLoad?.(e);
  }, [handle, onLoad, continueRender2]);
  const didGetError = (0, import_react60.useCallback)((e) => {
    continueRender2(handle);
    if (onError) {
      onError(e);
    } else {
  ...
  return (0, import_jsx_runtime25.jsx)("iframe", {
...
var IFrame = (0, import_react60.forwardRef)(IFrameRefForwarding);
...
var ImgInner = ({
  ...
  const errors = (0, import_react61.useRef)({});
  const { delayPlayback } = useBufferState();
  ...
  const retryIn = (0, import_react61.useCallback)((timeout) => {
    if (!imageRef.current) {
      return;
    }
  ...
  const { delayRender: delayRender2, continueRender: continueRender2, cancelRender: cancelRender2 } = useDelayRender();
  const didGetError = (0, import_react61.useCallback)((e) => {
    if (!errors.current) {
      return;
    }
...
var compositionsRef = import_react63.default.createRef();
var CompositionManagerProvider = ({
  ...
  const [folders, setFolders] = (0, import_react64.useState)([]);
  const [canvasContent, setCanvasContent] = (0, import_react64.useState)(initialCanvasContent);
  const [compositions, setCompositions] = (0, import_react64.useState)(initialCompositions);
  const currentcompositionsRef = (0, import_react64.useRef)(compositions);
  const updateCompositions = (0, import_react64.useCallback)((updateComps) => {
  ...
  const registerComposition = (0, import_react64.useCallback)((comp) => {
  ...
  const unregisterComposition = (0, import_react64.useCallback)((id) => {
    setCompositions((comps) => {
      return comps.filter((c2) => c2.id !== id);
    });
  }, []);
  const registerFolder = (0, import_react64.useCallback)((name, parent, nonce) => {
  ...
  const unregisterFolder = (0, import_react64.useCallback)((name, parent) => {
    setFolders((prevFolders) => {
      return prevFolders.filter((p) => !(p.name === name && p.parent === parent));
    });
  }, []);
  (0, import_react64.useImperativeHandle)(compositionsRef, () => {
    return {
      getCompositions: () => currentcompositionsRef.current
    };
  }, []);
  const compositionManagerSetters = (0, import_react64.useMemo)(() => {
    return {
      registerComposition,
      unregisterComposition,
      registerFolder,
  ...
  const compositionManagerContextValue = (0, import_react64.useMemo)(() => {
    return {
      compositions,
      folders,
      currentCompositionMetadata,
  ...
  return (0, import_jsx_runtime27.jsx)(CompositionManager.Provider, {
    value: compositionManagerContextValue,
    children: (0, import_jsx_runtime27.jsx)(CompositionSetters.Provider, {
...
var MaxMediaCacheSizeContext = import_react65.default.createContext(null);
var Root = null;
var listeners = [];
...
var MediaEnabledContext = (0, import_react67.createContext)(null);
var useVideoEnabled = () => {
  const context = (0, import_react67.useContext)(MediaEnabledContext);
  if (!context) {
...
var MediaEnabledProvider = ({
  ...
  const value = (0, import_react67.useMemo)(() => ({ videoEnabled, audioEnabled }), [videoEnabled, audioEnabled]);
  return (0, import_jsx_runtime28.jsx)(MediaEnabledContext.Provider, {
    value,
    children
  });
};
var RemotionRootContexts = ({
  ...
  const nonceContext = (0, import_react66.useMemo)(() => {
    let counter = 0;
    return {
      getNonce: () => counter++
    };
  }, []);
  const logging = (0, import_react66.useMemo)(() => {
    return { logLevel, mountTime: Date.now() };
  }, [logLevel]);
  return (0, import_jsx_runtime29.jsx)(LogLevelContext.Provider, {
    value: logging,
    children: (0, import_jsx_runtime29.jsx)(NonceContext.Provider, {
      value: nonceContext,
      children: (0, import_jsx_runtime29.jsx)(TimelineContextProvider, {
        frameState,
        children: (0, import_jsx_runtime29.jsx)(MediaEnabledProvider, {
          videoEnabled,
          audioEnabled,
          children: (0, import_jsx_runtime29.jsx)(EditorPropsProvider, {
            children: (0, import_jsx_runtime29.jsx)(PrefetchProvider, {
              children: (0, import_jsx_runtime29.jsx)(SequenceManagerProvider, {
                visualModeEnabled,
                children: (0, import_jsx_runtime29.jsx)(DurationsContextProvider, {
                  children: (0, import_jsx_runtime29.jsx)(BufferingProvider, {
                    children: (0, import_jsx_runtime29.jsx)(SharedAudioContextProvider, {
                      audioLatencyHint,
                      audioEnabled,
                      children: (0, import_jsx_runtime29.jsx)(SharedAudioTagsContextProvider, {
                        numberOfAudioTags,
                        children
                      })
                    })
...
var SequenceStackTracesUpdateContext = import_react68.default.createContext(() => {
});
var getEnvVariables = () => {
  if (getRemotionEnvironment().isRendering) {
...
var CurrentScaleContext = import_react69.default.createContext(null);
var PreviewSizeContext = (0, import_react69.createContext)({
  setSize: () => {
    return;
  },
...
var useCurrentScale = (options) => {
  const hasContext = import_react69.default.useContext(CurrentScaleContext);
  const zoomContext = import_react69.default.useContext(PreviewSizeContext);
...
var useSequenceControlOverride = (key) => {
  const seqContext = (0, import_react70.useContext)(SequenceContext);
  const { dragOverrides: overrides } = (0, import_react70.useContext)(VisualModeOverridesContext);
  if (!seqContext) {
    return;
  }
...
var OffthreadVideoForRendering = ({
  ...
  const id = (0, import_react72.useMemo)(() => `offthreadvideo-${random(src)}-${sequenceContext?.cumulatedFrom}-${sequenceContext?.relativeFrom}-${sequenceContext?.durationInFrames}`, [
    src,
    sequenceContext?.cumulatedFrom,
    sequenceContext?.relativeFrom,
    sequenceContext?.durationInFrames
  ...
  const currentTime = (0, import_react72.useMemo)(() => {
  ...
  const actualSrc = (0, import_react72.useMemo)(() => {
  ...
  const [imageSrc, setImageSrc] = (0, import_react72.useState)(null);
  const { delayRender: delayRender2, continueRender: continueRender2 } = useDelayRender();
  ...
  const onErr = (0, import_react72.useCallback)(() => {
    if (onError) {
  ...
  const className = (0, import_react72.useMemo)(() => {
    return [OBJECTFIT_CONTAIN_CLASS_NAME, props2.className].filter(truthy).join(" ");
  }, [props2.className]);
  const onImageFrame = (0, import_react72.useCallback)((img) => {
    if (onVideoFrame) {
      onVideoFrame(img);
    }
  }, [onVideoFrame]);
...
var VideoForDevelopmentRefForwardingFunction = (props2, ref) => {
  const context = (0, import_react73.useContext)(SharedAudioContext);
  if (!context) {
    throw new Error("SharedAudioContext not found");
  }
  const videoRef = (0, import_react73.useRef)(null);
  const sharedSource = (0, import_react73.useMemo)(() => {
  ...
  const effectToUse = import_react73.default.useInsertionEffect ?? import_react73.default.useLayoutEffect;
  effectToUse(() => {
    return () => {
      requestAnimationFrame(() => {
  ...
  const parentSequence = (0, import_react73.useContext)(SequenceContext);
  const { hidden } = (0, import_react73.useContext)(SequenceVisibilityToggleContext);
  const logLevel = useLogLevel();
  const mountTime = useMountTime();
  const [timelineId] = (0, import_react73.useState)(() => String(Math.random()));
  const isSequenceHidden = hidden[timelineId] ?? false;
  ...
  (0, import_react73.useState)(() => playbackLogging({
    logLevel,
  ...
  const currentOnDurationCallback = (0, import_react73.useRef)(onDuration);
  currentOnDurationCallback.current = onDuration;
  ...
  const actualStyle = (0, import_react73.useMemo)(() => {
    return {
      ...style,
  ...
  return (0, import_jsx_runtime31.jsx)("video", {
    ref: videoRef,
    muted: muted || mediaMuted || isSequenceHidden || userPreferredVolume <= 0,
    playsInline: true,
    src: actualSrc,
...
var VideoForPreview = (0, import_react73.forwardRef)(VideoForDevelopmentRefForwardingFunction);
var InnerOffthreadVideo = (props2) => {
  ...
  const onDuration = (0, import_react71.useCallback)(() => {
    return;
  }, []);
  ...
  if (typeof trimBeforeValue !== "undefined" || typeof trimAfterValue !== "undefined") {
    return (0, import_jsx_runtime32.jsx)(Sequence, {
      layout: "none",
      from: 0 - (trimBeforeValue ?? 0),
      showInTimeline: false,
      durationInFrames: trimAfterValue,
      name,
      children: (0, import_jsx_runtime32.jsx)(InnerOffthreadVideo, {
        pauseWhenBuffering: pauseWhenBuffering ?? false,
        ...otherProps,
        trimAfter: void 0,
        name: void 0,
  ...
  if (environment.isRendering) {
    return (0, import_jsx_runtime32.jsx)(OffthreadVideoForRendering, {
      pauseWhenBuffering: pauseWhenBuffering ?? false,
      ...otherProps,
      trimAfter: void 0,
      name: void 0,
  ...
  return (0, import_jsx_runtime32.jsx)(VideoForPreview, {
    _remotionInternalStack: stack ?? null,
    onDuration,
...
var OffthreadVideo = ({
  ...
  return (0, import_jsx_runtime32.jsx)(InnerOffthreadVideo, {
    acceptableTimeShiftInSeconds,
...
function useRemotionContexts() {
  const compositionManagerCtx = import_react75.default.useContext(CompositionManager);
  const timelineContext = import_react75.default.useContext(TimelineContext);
  const setTimelineContext = import_react75.default.useContext(SetTimelineContext);
  const sequenceContext = import_react75.default.useContext(SequenceContext);
  const nonceContext = import_react75.default.useContext(NonceContext);
  const canUseRemotionHooksContext = import_react75.default.useContext(CanUseRemotionHooks);
  const preloadContext = import_react75.default.useContext(PreloadContext);
  const resolveCompositionContext = import_react75.default.useContext(ResolveCompositionContext);
  const renderAssetManagerContext = import_react75.default.useContext(RenderAssetManager);
  const sequenceManagerContext = import_react75.default.useContext(SequenceManager);
  const bufferManagerContext = import_react75.default.useContext(BufferingContextReact);
  const logLevelContext = import_react75.default.useContext(LogLevelContext);
...
var RemotionContextProvider = (props2) => {
  ...
  return (0, import_jsx_runtime33.jsx)(LogLevelContext.Provider, {
    value: contexts.logLevelContext,
    children: (0, import_jsx_runtime33.jsx)(CanUseRemotionHooks.Provider, {
      value: contexts.canUseRemotionHooksContext,
      children: (0, import_jsx_runtime33.jsx)(NonceContext.Provider, {
        value: contexts.nonceContext,
        children: (0, import_jsx_runtime33.jsx)(PreloadContext.Provider, {
          value: contexts.preloadContext,
          children: (0, import_jsx_runtime33.jsx)(CompositionManager.Provider, {
            value: contexts.compositionManagerCtx,
            children: (0, import_jsx_runtime33.jsx)(SequenceManager.Provider, {
              value: contexts.sequenceManagerContext,
              children: (0, import_jsx_runtime33.jsx)(RenderAssetManager.Provider, {
                value: contexts.renderAssetManagerContext,
                children: (0, import_jsx_runtime33.jsx)(ResolveCompositionContext.Provider, {
                  value: contexts.resolveCompositionContext,
                  children: (0, import_jsx_runtime33.jsx)(TimelineContext.Provider, {
                    value: contexts.timelineContext,
                    children: (0, import_jsx_runtime33.jsx)(SetTimelineContext.Provider, {
                      value: contexts.setTimelineContext,
                      children: (0, import_jsx_runtime33.jsx)(SequenceContext.Provider, {
                        value: contexts.sequenceContext,
                        children: (0, import_jsx_runtime33.jsx)(BufferingContextReact.Provider, {
...
var compositionSelectorRef = (0, import_react62.createRef)();
var Internals = {
...
var flattenChildren = (children) => {
  const childrenArray = import_react77.default.Children.toArray(children);
  return childrenArray.reduce((flatChildren, child) => {
    if (child.type === import_react77.default.Fragment) {
...
var IsInsideSeriesContext = (0, import_react78.createContext)(false);
var IsInsideSeriesContainer = ({ children }) => {
  return (0, import_jsx_runtime34.jsx)(IsInsideSeriesContext.Provider, {
    value: true,
    children
  });
};
...
var useRequireToBeInsideSeries = () => {
  const isInsideSeries = import_react78.default.useContext(IsInsideSeriesContext);
  if (!isInsideSeries) {
...
var SeriesSequenceRefForwardingFunction = ({ children }, _ref) => {
  ...
  return (0, import_jsx_runtime35.jsx)(IsNotInsideSeriesProvider, {
    children
  });
};
var SeriesSequence = (0, import_react76.forwardRef)(SeriesSequenceRefForwardingFunction);
var SeriesInner = (props2) => {
  const childrenValue = (0, import_react76.useMemo)(() => {
    let startFrame = 0;
    const flattenedChildren = flattenChildren(props2.children);
    return import_react76.Children.map(flattenedChildren, (child, i) => {
      ...
      return (0, import_jsx_runtime35.jsx)(Sequence, {
  ...
  return (0, import_jsx_runtime35.jsx)(IsInsideSeriesContainer, {
    children: (0, import_jsx_runtime35.jsx)(Sequence, {
      layout: "none",
      name: "<Series>",
      ...props2,
...
var Still = (props2) => {
  ...
  return import_react79.default.createElement(Composition, newProps);
};
...
var VideoForRenderingForwardFunction = ({
  ...
  const videoConfig = useUnsafeVideoConfig();
  const videoRef = (0, import_react81.useRef)(null);
  const sequenceContext = (0, import_react81.useContext)(SequenceContext);
  const mediaStartsAt = useMediaStartsAt();
  const environment = useRemotionEnvironment();
  const logLevel = useLogLevel();
  const mountTime = useMountTime();
  const { delayRender: delayRender2, continueRender: continueRender2 } = useDelayRender();
  const { registerRenderAsset, unregisterRenderAsset } = (0, import_react81.useContext)(RenderAssetManager);
  const id = (0, import_react81.useMemo)(() => `video-${random(props2.src ?? "")}-${sequenceContext?.cumulatedFrom}-${sequenceContext?.relativeFrom}-${sequenceContext?.durationInFrames}`, [
    props2.src,
    sequenceContext?.cumulatedFrom,
    sequenceContext?.relativeFrom,
    sequenceContext?.durationInFrames
  ...
  return (0, import_jsx_runtime36.jsx)("video", {
    ref: videoRef,
    disableRemotePlayback: true,
    ...props2
  });
};
var VideoForRendering = (0, import_react81.forwardRef)(VideoForRenderingForwardFunction);
var VideoForwardingFunction = (props2, ref) => {
  ...
  const { durations, setDurations } = (0, import_react80.useContext)(DurationsContext);
  ...
  const onDuration = (0, import_react80.useCallback)((src, durationInSeconds) => {
    setDurations({ type: "got-duration", durationInSeconds, src });
  }, [setDurations]);
  const onVideoFrame = (0, import_react80.useCallback)(() => {
  }, []);
  ...
  if (loop && durationFetched !== void 0) {
    if (!Number.isFinite(durationFetched)) {
      return (0, import_jsx_runtime37.jsx)(Html5Video, {
        ...propsOtherThanLoop,
        ref,
        stack,
        _remotionInternalNativeLoopPassed: true
    ...
    return (0, import_jsx_runtime37.jsx)(Loop, {
      durationInFrames: calculateMediaDuration({
        trimAfter: trimAfterValue,
      ...
      name,
      showInTimeline: false,
      children: (0, import_jsx_runtime37.jsx)(Html5Video, {
        ...propsOtherThanLoop,
        ref,
        stack,
        _remotionInternalNativeLoopPassed: true
  ...
  if (typeof trimBeforeValue !== "undefined" || typeof trimAfterValue !== "undefined") {
    return (0, import_jsx_runtime37.jsx)(Sequence, {
      layout: "none",
      from: 0 - (trimBeforeValue ?? 0),
      showInTimeline: false,
  ...
  if (environment.isRendering) {
    return (0, import_jsx_runtime37.jsx)(VideoForRendering, {
      onDuration,
      onVideoFrame: onVideoFrame ?? null,
      ...otherProps,
      ref
  ...
  return (0, import_jsx_runtime37.jsx)(VideoForPreview, {
    onlyWarnForMediaSeekingError: false,
    ...otherProps,
    ref,
    onVideoFrame: null,
...
var Html5Video = (0, import_react80.forwardRef)(VideoForwardingFunction);
...
//# sourceMappingURL=chunk-ZUYHMF6Q.js.map
