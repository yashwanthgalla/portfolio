...
const VideoForwardingFunction = (props, ref) => {
    ...
    if (loop && durationFetched !== undefined) {
        ...
        return ((0, jsx_runtime_1.jsx)(index_js_1.Loop, { durationInFrames: (0, calculate_media_duration_js_1.calculateMediaDuration)({
            ...
            }), layout: "none", name: name, showInTimeline: false, children: (0, jsx_runtime_1.jsx)(exports.Html5Video, { ...propsOtherThanLoop, ref: ref, stack: stack, _remotionInternalNativeLoopPassed: true }) }));
    }
